<div id="strategic-plans">
  ...
  <div class="h-auto xl:px-[14%] md:px-[8%] bg-cover bg-center relative shadow-lg"
    ...
    <div class="relative w-full h-auto">
      <div id="slides">
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            A hybrid physical-digital hub in Quezon City serving as a
            one-stop center for invention showcasing, IP support, and technology transfer.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Showroom for Filipino-made technologies and products
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Co-working space and fabrication lab
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> IP registration and legal assistance desk
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Online platform for e-commerce and investor engagement
              </p>
            </div>
          </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            FISMPC will prioritize inventions focused on renewable energy, waste recycling, smart agriculture, and green technologies.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Partnerships with LGUs for local green tech adoption
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Solar microgrid and low-cost water purification systems
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> Promotion of biodegradable and sustainable packaging solutions
              </p>
            </div>
          </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="mt-22 px-2">Strengthen the cooperative’s financial sustainability and
            provide accessible capital to inventors.
          </p>
          ...
          <p class="text-lg mt-15 px-6">
            A revolving fund and investment program sourced from cooperative members, CSR partners, and institutional investors.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Loan facilities for product development and patent filing
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Equity participation in scalable invention enterprises
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> Partnership with cooperative banks and fintech platforms
              </p>
            </div>
          </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            Launch of FISMPC’s Digital Member Portal and integration of blockchain-based IP timestamping for inventor protection.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> Digital Member Portal for registration, payments, and e-learning
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Blockchain IP timestamping system
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> AI-driven design, prototyping, and e-commerce partnerships
              </p>
            </div>
          </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            Capacity-building programs and workshops nationwide with partner agencies and universities.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">InventPreneur Bootcamp on business planning and scaling
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">IP 101, Patent Filing, and Industrial Design Workshops
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">TESDA and DOST-linked technical courses
              </p>
            </div>
          </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            Annual celebration and exhibit of Filipino inventions with awards for outstanding innovators.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">National exhibit and showcase
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Youth inventor awards and cooperative innovation recognition
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed"> Networking events and media exposure
              </p>
            </div>
        ...
        <div class="slide hidden relative p-10 w-full h-auto bg-[#F3F6FA] rounded-2xl p-6">
          ...
          <p class="text-lg mt-15 px-6">
            Establish regional innovation clusters across Luzon, Visayas, and Mindanao.
          </p>
          ...
          <div class="space-y-2 px-13">
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Regional partnerships with universities and LGUs
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Mentorship and incubation at local levels
              </p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <p class="text-lg leading-relaxed">Access to cooperative credit and resources
              </p>
            </div>
          </div>
    ...
    <div class="absolute inset-y-0 left-0 flex items-center px-8 md:px-0 md:pr-15">
    ...
    <div class="absolute inset-y-0 right-0 flex items-center px-8 md:px-0 md:pl-15">
