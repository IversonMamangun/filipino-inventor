...
<div class="grid grid-cols-2 gap-8 h-screen-2xl px-15 mb-8">
  ...
  <div class="grid grid-rows-2 gap-8">
    ...
    <div class="bg-white shadow-2xl rounded-lg p-6 text-start">
      <p class="text-xl leading-relaxed text-[#033E94]">
  ...
  <div class="bg-[#DE9F1B] shadow-xl rounded-lg ">
    <!-- Header -->
    <div class="relative flex items-center w-full mb-4 mt-6">
